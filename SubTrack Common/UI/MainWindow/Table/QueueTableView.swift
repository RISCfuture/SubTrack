...
struct QueueTableView: View {
  ...
  /**
   Which columns are shown, and in what order. Five of the seven can be hidden —
   four narrow capped metrics plus Destination — so dropping the ones a given
   user doesn't read hands that width back to Name.
   */
